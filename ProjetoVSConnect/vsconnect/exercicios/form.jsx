...
function FormularioCadastro() {
  ...
  // TODO 2: crie três estados abaixo
   const [nome,  __setNome_] = useState("");
   const [email, __setemail_] = useState("");
   const [senha, __setsenha_] = useState("");

  function enviar(event) {
    event.preventDefault();

    // TODO 4: exiba os três valores no console com console.log
     console.log("Nome:",  _nome__);
    console.log("Email:", __email_);
     console.log("Senha:", __senha_);
  }
  ...
  return (
    <form onSubmit={enviar}>
      ...
      <input
        ...
        value={nome}
        onChange={(e) => __setNome_(e.target.value)}
      />
      ...
      <input
        ...
        value={email}
        onChange={(e) => __setemail_(e.target.value)}
      />
      ...
      <input
        ...
        value={senha}
        onChange={(e) => __setsenha_(e.target.value)}
      />
